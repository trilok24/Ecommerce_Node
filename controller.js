...
const createPaymentOrder = async (req, res) => {
  try {
    const { amount } = req.body;  // Amount in smallest currency unit (paise or cents)
...
const paymentVerification = async (req, res) => {
  ...
  const generatedSignature = crypto.createHmac('sha256', 'YOUR_RAZORPAY_KEY_SECRET')  // Use your Razorpay key secret
